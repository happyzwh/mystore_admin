...
strFrame+='          <tr Author="wayx"><td Author=meizz align=left nowrap=nowrap><input Author=meizz type=button class=button value="<<" title="向前翻 1 年"  onMouseDown="parent.startPrevY();" onMouseUp="parent.stopPrevY();" ';
...
strFrame+='             <input Author=meizz type=button class=button value=清空 onclick="parent.clearDay()" ';
strFrame+='             onfocus="this.blur()" title="清空日期" style="font-size: 10px; height: 20px; cursor:hand">';
strFrame+='             <input Author=meizz type=button class=button value=当前 onclick="parent.meizzToday()" ';
strFrame+='             onfocus="this.blur()" title="当前日期" style="font-size: 10px; height: 20px; cursor:hand">';
...
function closeLayer()               //这个层的关闭
  {
  	var meizzDateLayer = document.getElementById("meizzDateLayer");
  	if(meizzDateLayer){
...
function clearDay()  //Clear Day Button
  {
    if(outObject)outObject.value="";
    closeLayer();
  }
