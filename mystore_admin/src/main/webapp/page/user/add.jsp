	        ...
	        $(function(){
	            ...
	            $("#save").click(function(){
	                ...
	                if($.trim($("#password").val()) == '' || $.trim($("#password").val()).length < 6){
	                    alert("提示：初始密码不能为空且长度应不小于6位！");
	                    return false;
	                }
	                
	                if($.trim($("#password_check").val()) == '' || $.trim($("#password_check").val()).length < 6){
	                    alert("提示：确认密码不能为空且长度应不小于6位！");
	                    return false;
	                }
	                
	                if($.trim($("#password_check").val()) != $.trim($("#password").val())){
	                    alert("提示：初始密码和确认密码不一致！");
	                    return false;
	                }
	                ...
	                $.ajax({
							...
							type: 'post',
							data: {'userName':$.trim($("#userName").val()),'account':$.trim($("#account").val()),
...
<body class="main">
	 ...
	 <div class="main" style="margin-bottom:20px;">
        <table cellspacing="0" cellpadding="0" class="table1">
           <tbody>
	           <tr>
	               <td colspan="4" class="title">添加用户</td>
	           </tr>
	           <tr>
	               <td width="15%" style="text-align:right;">帐号：</td>
	               <td width="20%" style="text-align:left;">
	                   <input type="text" id="account" name="account" style="width:250px;height:28px;" maxlength="25" /> 
	               </td>
	               <td width="15%" style="text-align:right;">真实姓名：</td>
	               <td width="20%" style="text-align:left;">
	                   <input type="text" id="userName" name="userName" style="width:250px;height:28px;" maxlength="50" /> 
	               </td>
	           </tr>
	           <tr>
	               <td width="15%" style="text-align:right;">初始密码：</td>
	               <td width="20%" style="text-align:left;">
	           ...
	           <tr>
	               ...
	               <td width="20%" style="text-align:left;">
	                   <input type="text" id="email" name="email" style="width:250px;height:28px;" maxlength="25" /> 
	               </td>
