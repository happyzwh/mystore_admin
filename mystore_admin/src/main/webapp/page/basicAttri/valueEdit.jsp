	        ...
	        $(function(){
	            ...
	            $("#save").click(function(){
	                ...
	                $.ajax({
							...
							type: 'post',
							data: {'pid':'<s:property value="#request.pid"/>','id':'<s:property value="#request.basicAttriValue.id"/>','value':$.trim($("#value").val()),'sort':$.trim($("#sort").val())},
							async: false,
							dataType: "text",
...
<body class="main">
	 ...
	 <div class="main" style="margin-bottom:20px;">
        <table cellspacing="0" cellpadding="0" class="table1">
           <tbody>
	           <tr>
	               <td colspan="4" class="title">修改属性值</td>
	           </tr>
	           <tr>
	               <td width="15%" style="text-align:right;">值 ：</td>
	               <td width="20%" style="text-align:left;">
	                   <input type="text" id="value" name="value" style="width:250px;height:28px;" maxlength="25" value="<s:property value='#request.basicAttriValue.value'/>"/> 
	               </td>
	               <td width="15%" style="text-align:right;">序号：</td>
	               <td width="20%" style="text-align:left;">
	                   <input type="text" id="sort" name="sort" style="width:250px;height:28px;" maxlength="2" value="<s:property value='#request.basicAttriValue.sort'/>"/> 
	               </td> 
	           </tr>
       	 </tbody>
        </table>
