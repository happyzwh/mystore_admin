	       ...
	       $(function(){ 
	            $("#ok").click(function(){
	               if(tree.getSelectedItemId() == -1){
	                    ...
	                    p.setBrand(tree.getSelectedItemId(),tree.getItemText(tree.getSelectedItemId()));
	                    window.close();
	               }
	            });
				...
				tree.loadXML("<%=path%>/brand/brandAction!getAllNote.dhtml", function(){
...
<body class="main">
	 <div class="location"><span>当前位置：品牌列表</span></div>
	 <div class="main">
