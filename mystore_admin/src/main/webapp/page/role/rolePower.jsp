	...
	<head>
	    ...
	    <script  type="text/javascript">
	       $(function(){ 
				...
				tree.loadXML('<%=path%>/role/roleAction!getAllNote.dhtml?id=<s:property value="#request.id"/>', function(){
	       ...
	       function saveRolePower(){
	           ...
	           $.ajax({
								url: '<%=path%>/role/roleAction!saveRolePower.dhtml',
								type: 'post',
...
<body class="main">
	 <div class="location"><span>当前位置：角色权限</span></div>
     ...
     <div style="width:100%;text-align:center;border:0px;" class="table1">
		   <input type="button" value="保存" class="query"  style="opacity: 1;margin:20px auto;" onclick="javascript:saveRolePower();"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="back" value="返回" class="query" style="opacity: 1;"/>
	 </div>
</body>
</html>
