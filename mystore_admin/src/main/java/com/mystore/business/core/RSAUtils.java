...
import com.mystore.business.util.ExceptionUtil;
...
public abstract class RSAUtils {
	...
	private static final Log loger = LogFactory.getLog(RSAUtils.class);
	...
	public  static String getRSAPairFilePath() {
		ResourceBundle systempProperties = PropertyResourceBundle.getBundle("rsa");
		String urlPath = systempProperties.getString("rsa.key.url");
//		String urlPath = RSAUtils.class.getClassLoader().getResource("/").getPath();
	...
	public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
		if (StringUtils.isBlank(hexModulus) || StringUtils.isBlank(hexPrivateExponent)) {
			if (loger.isDebugEnabled()) {
				loger.debug("hexModulus and hexPrivateExponent cannot be empty. RSAPrivateKey value is null to return.");
			}
			return null;
		}
		byte[] modulus = null;
	...
	public static RSAPublicKey getRSAPublidKey(String hexModulus, String hexPublicExponent) {
		if (StringUtils.isBlank(hexModulus) || StringUtils.isBlank(hexPublicExponent)) {
			if (loger.isDebugEnabled()) {
				loger.debug("hexModulus and hexPublicExponent cannot be empty. return null(RSAPublicKey).");
			}
			return null;
		}
		byte[] modulus = null;
